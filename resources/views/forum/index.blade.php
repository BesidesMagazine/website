		...
		<img src="img/forum_banner.png" class="forum-banner-img"/>
			...
			<div class="forum-origin">
				...
				<p class="forum-p"  id="forum-origin">
					《除了》2016 異想論壇，緣起於《除了》雜誌核心理念之推動，建立一多元發聲之議題平台，讓各項領域之議題皆能有機會獲得重視，並結合新世代重視之創新創造的發想能力，展現不同的視野；希望透過此次論壇，結合文化藝術、影視對話、媒體傳播、創新創業、社會參與五大領域十一位傑出講者的分享，將此「異想」之理念傳遞與參與者。
				</p>
				<h1 class="forum-h">
					關於異想
				</h1>
				...
				<span class="forum-agenda-category">
					逆行思維</span>
				<p class="forum-p">
					堅持走不同的路，需要逆行的勇氣，在不斷的失敗與堅持中，突破傳統思維框架，碰撞既定的成見，重視持續的反思與挫敗的價值，在時代裡創造屬於自己的獨特標誌。
				</p>

				<span class="forum-agenda-category">
					異想世界</span>
				<p class="forum-p">
					天馬行空的點子，是許多成功者擁有的特質，儘管在這樣的異想世界中，最終獲得實現的想法為少數，但卻往往發揮了極大的影響與價值。從零開始去用心孕育一個故事，過程中留下的激盪，更是重要的成長。
				</p>
			</div>
